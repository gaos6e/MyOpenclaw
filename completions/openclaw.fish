...
complete -c openclaw -n "__fish_use_subcommand" -a "tasks" -d 'Inspect durable background task state'
...
complete -c openclaw -n "__fish_use_subcommand" -a "memory-hub" -d 'OpenClaw memory hub commands'
...
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -a "audit" -d 'Show stale or broken background task runs'
complete -c openclaw -n "__fish_seen_subcommand_from tasks" -a "maintenance" -d 'Preview or apply task ledger maintenance'
...
complete -c openclaw -n "__fish_seen_subcommand_from audit" -l code -d 'Filter by finding code (stale_queued, stale_running, lost, delivery_failed, missing_cleanup, inconsistent_timestamps)'
...
complete -c openclaw -n "__fish_seen_subcommand_from memory-hub" -a "status" -d ''
complete -c openclaw -n "__fish_seen_subcommand_from memory-hub" -a "index" -d ''
complete -c openclaw -n "__fish_seen_subcommand_from memory-hub" -a "vector-index" -d ''
complete -c openclaw -n "__fish_seen_subcommand_from memory-hub" -a "vector-search" -d ''
complete -c openclaw -n "__fish_seen_subcommand_from memory-hub" -a "search" -d ''
complete -c openclaw -n "__fish_seen_subcommand_from memory-hub" -a "backfill" -d ''
complete -c openclaw -n "__fish_seen_subcommand_from memory-hub" -a "candidates" -d ''
complete -c openclaw -n "__fish_seen_subcommand_from memory-hub" -a "extract" -d ''
complete -c openclaw -n "__fish_seen_subcommand_from memory-hub" -a "promote" -d ''
complete -c openclaw -n "__fish_seen_subcommand_from status" -l json -d 'output json'
complete -c openclaw -n "__fish_seen_subcommand_from index" -l force -d 'force full reindex'
complete -c openclaw -n "__fish_seen_subcommand_from vector-index" -l json -d 'output json'
complete -c openclaw -n "__fish_seen_subcommand_from vector-search" -l query -d 'query text'
complete -c openclaw -n "__fish_seen_subcommand_from vector-search" -l max-results -d 'max results'
complete -c openclaw -n "__fish_seen_subcommand_from vector-search" -l json -d 'output json'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l query -d 'query text'
...
complete -c openclaw -n "__fish_seen_subcommand_from backfill" -l json -d 'output json'
complete -c openclaw -n "__fish_seen_subcommand_from candidates" -l json -d 'output json'
complete -c openclaw -n "__fish_seen_subcommand_from extract" -l source -d 'source text'
complete -c openclaw -n "__fish_seen_subcommand_from extract" -l max-candidates -d 'max candidates'
complete -c openclaw -n "__fish_seen_subcommand_from promote" -l target -d 'promotion target'
